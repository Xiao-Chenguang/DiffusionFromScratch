...
def plot_show_callback(i, t, latents):
    ...
    plt.imsave(
        f"/home/binxuwang/DL_Projects/SDfromScratch/diffproc/sample_{i:02d}.png",
        image[0],
    )
...
plt_show_image(
    latents_reservoir[-1][0, [0, 1, 2], :].permute(1, 2, 0).cpu().numpy() / 1.6 + 0.4
)
...
torch.save(
    ...
    "/home/binxuwang/DL_Projects/SDfromScratch/SD_unet.pt",
)
torch.save(
    pipe.vae.state_dict(),
    "/home/binxuwang/DL_Projects/SDfromScratch/SD_vae.pt",
)
